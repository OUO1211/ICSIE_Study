...
稱 $K(\lambda)=\bigcup_{i=1}^{\infty}\left(\operatorname{ker}(T-\lambda I)^i\right)$ 為 $T$ 相對於 $\lambda$ 的廣義特徵空間。
Note
...
【92．101．104師大資工】
解（1） $\operatorname{char}_A(x)=\left|\begin{array}{cc}1-x & 1 \\ -1 & 3-x\end{array}\right|=x^2-4 x+4=(x-2)^2$ ，得特徵根2．
