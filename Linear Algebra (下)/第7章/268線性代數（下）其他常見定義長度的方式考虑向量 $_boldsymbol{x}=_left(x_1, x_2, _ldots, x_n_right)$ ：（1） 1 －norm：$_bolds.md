...
& \|\boldsymbol{x}\|_2^2=\sum_{i=1}^n\left|x_i\right|^2=\left|x_1\right|^2+\ldots+\left|x_n\right|^2 \leq n\left|x_k\right|^2=n\|\boldsymbol{x}\|_{\infty}^2 \therefore\|\boldsymbol{x}\|_2 \leq \sqrt{n}\|\boldsymbol{x}\|_{\infty}, \therefore \frac{\|\boldsymbol{x}\|_2}{\sqrt{n}} \leq\|\boldsymbol{x}\|_{\infty}, \\
