...
性質
考慮函數 $f: A \rightarrow B$ ，且 $A_1, A_2$ 为 $A$ 的雨子集，則
...
若 $f: A \rightarrow B$ 可逆，且 $B_1, B_2$ 必 $B$ 的兩子集，则
...
若 $y \in \overline{f\left(A_1\right)}$ ，則 $y \in f\left(A_1\right)$ ，即存在 $z \in A_1$ ，使 $y=f(z)$ ，與 $f$ 有 $1-1$ 予盾 ＊故得 $y \in \overline{f\left(A_1\right)}, f\left(\overline{A_1}\right) \subseteq \overline{f\left(A_1\right)}$ 。
