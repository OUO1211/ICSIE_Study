...
（2）$A$ 稱為函數 $f$ 的定義域（domain），$B$ 稱為函數 $f$ 的虚應域或陪域（co－domain）。
...
（5）$f$ 為㴲增函數（increasing），若 $f$ 滿足：對任何 $x, y$ ，若 $x<y$ ，則 $f(x)<f(y)$ 。 （有些書上定義成厳格遞增）
（6）$f$ 為㴲減函數（decreasing），若 $f$ 滿足：對任何 $x, y$ ，若 $x<y$ ，則 $f(x)>f(y)$ 。 （有些書上定義成厳格㴲減）
（7）$f$ 為非㴲滅函數（non－decreasing），若 $f$ 滿足：對任何 $x, y$ ，若 $x<y$ ，則 $f(x) \leq f(y){ }^{\circ}$ （有些書上定義成㴲增）
（8）$f$ 右非㴲增雨数（non－increasing），若 $f$ 滿足：對任何 $x, y$ ，若 $x<y$ ，則 $f(x) \geq f(y)$ 。 （有些書上定義成派減）